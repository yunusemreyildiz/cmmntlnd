...
class Config:
    ...
    def reload_from_env(cls) -> None:
        """Ortam değişkenlerini yeniden oku (Web UI export / ayar kaydı sonrası)."""
        cls.SLACK_WEBHOOK_URL = os.getenv('SLACK_WEBHOOK_URL')
        cls.SLACK_CHANNEL = os.getenv('SLACK_CHANNEL', '#app-reviews')
        cls.APP_STORE_APP_ID = os.getenv('APP_STORE_APP_ID')
        cls.APP_STORE_COUNTRY = os.getenv('APP_STORE_COUNTRY', 'all')
        cls.GOOGLE_PLAY_APP_ID = os.getenv('GOOGLE_PLAY_APP_ID')
        cls.GOOGLE_PLAY_COUNTRY = os.getenv('GOOGLE_PLAY_COUNTRY', 'all')
        cls.CHECK_INTERVAL_MINUTES = int(os.getenv('CHECK_INTERVAL_MINUTES', '60'))
        cls.MAX_REVIEWS_PER_CHECK = int(os.getenv('MAX_REVIEWS_PER_CHECK', '10'))
        cls.CLEANUP_DAYS = int(os.getenv('CLEANUP_DAYS', '30'))
        cls.MAX_STORED_REVIEWS = int(os.getenv('MAX_STORED_REVIEWS', '1000'))
